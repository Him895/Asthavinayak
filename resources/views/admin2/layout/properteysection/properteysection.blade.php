...
@endif
            ...
            <form action="{{ route('admin2.propertey.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <input type="number" class="form-control" placeholder="Enter price" name="price" step="0.01" required>
                ...
                <input type="text" class="form-control" placeholder="Enter Address" name="address" required>
                 ...
                 <div class="mb-3">
                   <label for="" class="form-label">property spesification</label>
  <textarea name="specification" class="form-control" placeholder="Enter property specification here..."></textarea>
                </div>
